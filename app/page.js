...
export default function Home() {
  ...
  return (
    ...
    <div className="p-8">
      ...
      <div className='text-2xl p-4'>Bienvenue {worker != undefined ? worker.name : "..."} </div>
      <div className=''>
      ...
      <button onClick={() => signOut()} className="text-center bottom-0 mb-5 bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded">
        se déconnecter
      </button>
    </div>
    </>
